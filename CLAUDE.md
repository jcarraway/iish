...
**Phase 0 — PREVENT expansion to Women's Endocrine Health (P0-8 to P0-EX6, 16 sessions):**
- Genomic layer completion: PRS calculation from extracted SNP dosages (P0-8), PRS → composite risk model integration (P0-9), ancestry confidence UI + partner testing referral (P0-10)
...
- Foundation (P0-1 to P0-6) + genomic layer (P0-7) complete.

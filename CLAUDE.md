...
**Phase 0 — PREVENT expansion to Women's Endocrine Health (P0-9 to P0-EX6, 15 sessions remaining):**
- Genomic layer completion: PRS → composite risk model integration (P0-9), ancestry confidence UI + partner testing referral (P0-10)
